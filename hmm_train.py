...
def viterbi_train(hmm, feature_list):
    ...
    for iter in range(NUM_ITERATIONS):
        ...
        # MODIFIED: prevent fast line outputting by using carriage return.
        ansi_output.update_line('Iteration {0}: log likelihood = {1}'.format(iter+1, total_errors))
...
def main():
    ...
    ### Modified code - init ansi filtering
    ansi_output.init_writing()
    ...
    print('\n---- All done. HMMs are saved in "{0}"'.format(MODEL_FILE))
